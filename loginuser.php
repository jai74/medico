...
if(isset($_POST['register'])){
    ...
    $_SESSION['userpswrd'] = $_POST['userpswrd'];
    $_SESSION['loggedin'] = true;
    $res = mysqli_query($conn,"SELECT * FROM users WHERE E_Mail ='" . $_POST["useremail"] . "'");
    $row = mysqli_fetch_row($res);
    $_SESSION['userid'] = $row[0];
    $_SESSION['username'] = $row[1];
    $result = mysqli_query($conn,"SELECT * FROM users WHERE E_Mail ='" . $_POST["useremail"] . "' and Password = '". $_POST["userpswrd"]."'");
...
<body>
    ...
    <div class="container" id="main" align=center>
        <h1 style="color: #000099; font-size: 50px;">User Login</h1><br>
        <form action="loginuser.php" method="post" name="docreg">
            <table>
                <tr>
                    <td>
                        E-mail: 
                ...
                <td colspan="2">
                    <input class="reg" type="submit" name="register" value="Login" style="width: 48.5%; text-align: center; display: inline;"/>
                    <input class="reg" style="width: 49%;" type="reset" value="Cancel"/>
                </td>
                <tr>
                    <td colspan="2" align="center">Don't have an account? <a href="registeruser.php"><u>Sign Up</u></a></td>
                </tr>
            </table>
        </form>
    </div>
